...
public abstract class Teletubby implements Serializable {
	...
	/**
	 * Prohibits subclass teletubbies from digging by throwing a
	 * TeletubbyException To enable digging, override this method in a subclass.
	...
	public boolean equals(Object obj) {
		...
		if (this.tubbySpecies == null ? other.tubbySpecies != null
				: !this.tubbySpecies.equals(other.tubbySpecies)) {
			return false;
		}
		if (this.tubbyWeight != other.tubbyWeight) {
			return false;
		}
		if (this.PoFoodFavorite == null ? other.PoFoodFavorite != null
				: !this.PoFoodFavorite.equals(other.PoFoodFavorite)) {
			return false;
		}
	...
	public int hashCode() {
		...
		hash = 43
				* hash
				+ (this.tubbySpecies != null ? this.tubbySpecies.hashCode() : 0);
		hash = 43 * hash + this.tubbyWeight;
		hash = 43
				* hash
				+ (this.PoFoodFavorite != null ? this.PoFoodFavorite.hashCode()
						: 0);
